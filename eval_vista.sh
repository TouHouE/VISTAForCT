...
python /mnt/src/VISTA_workspace/VISTAForCT/inference/eval_vista.py --ckpt_path=$ckpt_path --vit_type=vit_h --output_folder=/mnt/src/VISTA_workspace/pred_train --image_size=512 \
	--json_form=/mnt/src/data/vista_table.json --image_folder=/mnt/src/data \
	--patch_embed_3d --debug=50 --b_min=0
